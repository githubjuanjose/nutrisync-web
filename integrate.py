...
var T=ES?{t:"Tu privacidad",p:"Usamos cookies esenciales para que NutriSync funcione. Analitica y personalizacion son opcionales y estan <b>desactivadas por defecto</b>.",e:"Esenciales",ed:"Necesarias para que la app funcione",eon:"Siempre activas",a:"Analitica",ad:"Uso anonimo para corregir errores",pz:"Personalizacion",pd:"Adapta los consejos a tus patrones",ok:"Aceptar todo",no:"Solo esenciales",pf:"Preferencias",sv:"Guardar preferencias"}
:{t:"Your privacy",p:"We use essential cookies to run NutriSync. Analytics &amp; personalization are optional and <b>off by default</b>.",e:"Essential",ed:"Required for the app to work",eon:"Always on",a:"Analytics",ad:"Anonymous usage to fix bugs",pz:"Personalization",pd:"Tailors tips to your patterns",ok:"Accept all",no:"Essentials only",pf:"Preferences",sv:"Save preferences"};
var F="font-family:'Poppins','Inter',system-ui,sans-serif";
var ROW="display:flex;align-items:center;justify-content:space-between;gap:14px;padding:10px 2px;border-top:1px solid #F3EBE2;font-size:13px";
...
+'<div style="'+ROW+'"><span><b style="font-weight:700">'+T.pz+'</b><br><small style="color:#8A7F78">'+T.pd+'</small></span><input type="checkbox" id="ns-pe" style="width:20px;height:20px;accent-color:#E8472A;cursor:pointer"></div></div>'
+'<div style="display:flex;gap:10px;flex-wrap:wrap;align-items:center">'
+'<button id="ns-accept" style="'+F+';border:none;border-radius:999px;padding:11px 20px;font-weight:700;font-size:13px;cursor:pointer;background:linear-gradient(135deg,#FF7600,#FD400C);color:#fff">'+T.ok+'</button>'
+'<button id="ns-reject" style="'+F+';border:1px solid #EADFD5;border-radius:999px;padding:10px 18px;font-weight:700;font-size:13px;cursor:pointer;background:#F8F2EB;color:#241D1A">'+T.no+'</button>'
+'<button id="ns-prefs" style="'+F+';border:none;background:none;padding:10px 6px;font-weight:700;font-size:13px;cursor:pointer;color:#C73A20;text-decoration:underline">'+T.pf+'</button></div>';
...
document.getElementById("ns-prefs").onclick=function(){var o=document.getElementById("ns-opts");if(o.style.display==="block"){save({essential:true,analytics:document.getElementById("ns-an").checked,personalization:document.getElementById("ns-pe").checked});}else{o.style.display="block";this.textContent=T.sv;}};}

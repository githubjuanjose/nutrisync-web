...
for _f in ("pilot-charts.js", "pilot-planning.html", "pilot-observability.html", "daily-ops.html", "decisions.html", "notifications.html", "incidents.html", "copy-review.html", "design-system.html"):
...
if os.path.exists(_ibc):
    ...
    _CARD = ('<div id="ns-pitch-deck">'
      ...
      '<a href="/hub/docs/NutriSync_Value_and_Business_Proposal_EN_v1_1.pdf" '
      'style="display:inline-block;background:#fff;color:#241D1A;font-weight:800;font-size:13px;'
      'border-radius:22px;padding:10px 20px;text-decoration:none">💼 Value & Business Proposal v1.1 (Sep 2026)</a>'
      '<a href="/hub/docs/NutriSync_Tony_Answers_EN_v1_1.pdf" '
      'style="display:inline-block;background:#fff;color:#241D1A;font-weight:800;font-size:13px;'
      'border-radius:22px;padding:10px 20px;text-decoration:none">💬 Answers for Tony v1.1 (PDF)</a>'
      ...
      '<a href="/hub/docs/NutriSync_Tony_Core_6_Slides_EN_v1_0.pptx" '
      'style="display:inline-block;background:#fff;color:#241D1A;font-weight:800;font-size:13px;'
      'border-radius:22px;padding:10px 20px;text-decoration:none">🎯 Tony follow-up · 6 core slides (PPTX)</a>'
      '<a href="/hub/docs/NutriSync_Tony_Deck_Insert_EN_v1_0.pptx" '
      'style="display:inline-block;background:#fff;color:#241D1A;font-weight:800;font-size:13px;'
      'border-radius:22px;padding:10px 20px;text-decoration:none">🎯 6 + 2 backups (PPTX)</a>'
      '<a href="/hub/docs/NutriSync_Tony_Deck_Insert_EN_v1_0.pdf" '
      'style="display:inline-block;background:#fff;color:#241D1A;font-weight:800;font-size:13px;'
      'border-radius:22px;padding:10px 20px;text-decoration:none">🎯 Preview (PDF)</a>'
      '<a href="/hub/docs/NutriSync_Tony_Insert_Guide_EN_v1_0.pdf" '
      'style="display:inline-block;background:#fff;color:#241D1A;font-weight:800;font-size:13px;'
      'border-radius:22px;padding:10px 20px;text-decoration:none">📋 Insert guide (PDF)</a>'
      '<a href="/hub/docs/NutriSync_PPT_Aug_2026.pptx" '
      'style="display:inline-block;background:#fff;color:#241D1A;font-weight:800;font-size:13px;'
      'border-radius:22px;padding:10px 20px;text-decoration:none">📽 Deck Aug 2026 (PPTX editable)</a>'

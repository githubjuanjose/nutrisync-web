...
const V = 'ns-web2-0709-190921';
const SHELL = ['/', '/offline/', '/manifest.webmanifest', '/assets/css/site.e8d69b93.css', '/assets/js/site.97dec567.js',
...
self.addEventListener('fetch', (e) => {
  ...
  if (/\/assets\/(img|fonts|icons|css|js)\//.test(url.pathname)) {
